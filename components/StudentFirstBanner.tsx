...
const StudentFirstBanner = () => {
  return (
    ...
    <Flex flexDirection={"column"} justifyContent={"flex-start"} alignItems={"center"} mt={"10rem"} px={"5%"}>
      ...
      <Text textStyle='primary' fontSize={"1.2rem"}  textAlign={"center"} mt={"1rem"} maxWidth={{base: "90%", sm: "85%", md: "75%", lg: "60%"}}>As a student-first platform, BlockSocDAO was designed to support the next generation of Web3 innovators.
      </Text>
    </Flex>
