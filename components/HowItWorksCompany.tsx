    ...
    return (
        ...
        <Box display={"flex"} flexDirection={"column"} justifyContent={"space-evenly"} >
          ...
          <Box bg={"rgba(52, 52, 52, 0.2)"} display={"flex"} flexDirection={"column"} p={"2rem"} width={"11rem"}>
            ...
            <Text pt={"2rem"} textStyle='secondary' fontSize={"20"}>Talent</Text>
          </Box>
          ...
          <Box bg={"rgba(52, 52, 52, 0.2)"} display={"flex"} flexDirection={"column"} p={"2rem"} width={"11rem"}>
            <Image src={discord_logo} width={"100px"} height={"100px"} />
            <Text textStyle='secondary' fontSize={"20"} pt={"2rem"} >Outsource</Text>
          </Box>
          <Box display={"flex"} flexDirection={"column"} justifyContent={"center"}>
          <Divider variant={"customLink"} orientation='horizontal' width={"11rem"} />
          </Box>
        ...
        <Box display={"flex"}>
          ...
          <Box bg={"rgba(52, 52, 52, 0.2)"} display={"flex"} flexDirection={"column"} p={"2rem"} width={"11rem"}>
            <Image src={discord_logo} width={"100px"} height={"100px"} />
            <Text pt={"2rem"} textStyle='secondary' fontSize={"20"}>Start-ups</Text>
          </Box>
          </Box>
        </Box>
