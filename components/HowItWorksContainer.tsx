...
const HowItWorksContainer = () => {
  ...
  const [studentFeatureInfoDisplay, setStudentFeatureInfoDisplay] = useState<string>("Education")
  const [companyFeatureInfoDisplay, setCompanyFeatureInfoDisplay] = useState<string>("Education")
